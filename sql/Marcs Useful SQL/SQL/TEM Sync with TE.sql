...
LEFT JOIN SIProcessing_Attribution..TrackedExposure te ON te.CreateDateUTC = tem.CreateDateUTC 
...
AND te.ChannelID = 4 
WHERE tem.ClientID = @clientID 
AND tem.TrackingSourceID = 3 
AND te.TrackedExposureID Is NULL 
