...
DECLARE @ClientID INT = 1,
	...
	FROM SIOLAP..RPT_PI_Summary_AgencyLevel
	...
	BEGIN
		...
		MERGE INTO SIOLAP..RPT_PI_Summary_AgencyLevel AS Target
		USING (
					...
					FROM SIOLAP..RPT_PI_Summary_Client rpt
					JOIN Searchignite..NatureSearchEngine ns ON rpt.PISEID = ns.NSEID
