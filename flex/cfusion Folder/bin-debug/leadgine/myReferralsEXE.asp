...
sub processData()
	...
	if myType = "table" then
		sqlLeads = "Select ID,Company,myEvent,Arrival, Sent_Date,TotalRooms,RmRevenue + RentalRevenue + CateringRevenue as Revenue,Bonus,myStatus from Referrals where RefUserID = " & usr & " order by Sent_Date,Company,myEvent "
