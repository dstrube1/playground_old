package leadgine.components
{
	...
	public class CheckTreeRenderer extends TreeItemRenderer
	{
		...
		protected function toggleParents (item:Object, tree:Tree, state:String):void
		{
			if (item == null)
			{
				return;
		...
		protected function toggleChildren (item:Object, tree:Tree, state:String):void
		{
			if (item == null)
			{
				return;
		...
		protected function getState(tree:Tree, parent:Object):String
		{
			var noChecks:int = 0;
			var noCats:int = 0;
		...
		protected function checkBoxToggleHandler(event:MouseEvent):void
		{
			if (data)
			{
 ...
 protected function imageToggleHandler(event:MouseEvent):void
  {
   if (enabled)
   {
    ...
    checkBoxToggleHandler(event);
		...
		override protected function createChildren():void
		{
			...
			addChild(myImage);
			//BindingUtils.bindProperty(myCheckBox,'enabled',this,'enabled');
			
	    }	

		protected function setCheckState (checkBox:CheckBox, value:Object, state:String):void
		{
