...
//	import flash.media.Video;
	...
	public class Uploader extends Canvas
	{
		...
		private var files_vb:HBox;
		private var files_vb_border:HBox;
		...
		private function creationCompleteHandler( event:FlexEvent ) :void
		{
            ...
            instruction.text = "Drag a file into the space below, or browse.";
            instruction.x = 90;
            instruction.y = 60;
            addChild(instruction);
            
            files_vb_border = new HBox();
            files_vb_border.width = 256;
            files_vb_border.height = 40;
            files_vb_border.x = 10;
            files_vb_border.y = 110;
            files_vb_border.setStyle("backgroundColor","red");
            addChild(files_vb_border);
			...
			files_vb.x=10;
			files_vb.y=110;
            files_vb.setStyle("backgroundColor","white");
			addChild(files_vb);
