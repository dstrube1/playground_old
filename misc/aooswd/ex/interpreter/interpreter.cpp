handling Boolean expressions in C++

	terminal symbols: true & false

	grammar (not handle operator precedence)
...
operations
	...
	Replace
		manipulates Boolean expression
...
public:
	...
	virtual BooleanExp* Replace (const char*, BooeanExp&) = 0;
...
BooleanExp* AndExp::Replace (const char* anem, BooleanExp& exp)
{
