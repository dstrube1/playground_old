...
var heart = "http://students.kennesaw.edu/~dstrube/images/heart.gif";
var flag;
...
for (i = 0; i < no; ++ i) {
	...
	if (ns4up) {                      // set layers
		...
		document.write("<a href=\"niagra.html\" target=\"_blank\"><img src=\"");
		document.write(heart+ "\" border=\"0\"></a></layer>");
		} 
	if (ie4up) {
		...
		document.write("<a href=\"niagra.html\" target=\"_blank\"><img src=\"");
		document.write(heart+ "\" border=\"0\"></a></div>");
	}
}
